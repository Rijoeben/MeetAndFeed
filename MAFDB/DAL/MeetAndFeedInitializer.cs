...
namespace DAL
{
    class MeetAndFeedInitializer
    {
        ...
        //public static void TestUsers(MeetAndFeedDbContext db) *Dit was een eerdere versie van test gegevens. Nu gebruiken we de ModelBuilderExtensions.cs om de vaste waarde in te vullen*
        //{
        //    User test = new User()
        //    {
        ...
        //public static void AllergyValues(MeetAndFeedDbContext db) *Dit was een eerdere versie van test gegevens. Nu gebruiken we de ModelBuilderExtensions.cs om de vaste waarde in te vullen*
        //{
